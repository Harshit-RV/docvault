  ...
  return (
    <div className='bg-[#0D111D] flex flex-col h-screen items-center pt-16 gap-8 overflow-y-auto pb-16'>
        ...
        <div className='flex gap-4 bg-[#1C1F2E] rounded-lg p-2'>
            <Tab 
                name="Verify NFT by ID" 
                active={activeTab==="tab1"} 
                onClick={()=>handleTabChange("tab1")} 
            />
            <Tab 
                name="Get all NFTs of Address" 
        ...
        {activeTab=== "tab1" && (
            <div className='flex flex-col gap-4 mt-12 w-full items-center'>
                ...
                <button 
                    ...
                    className='mt-8 bg-[#27E8A7] w-28 text-black font-bold py-3 px-6 rounded-md hover:bg-[#20C08F] transition-colors'>
